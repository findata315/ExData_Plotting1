#Before plotting, set working directory to the folder under which the unzipped data is stored. 
#We then need to read in data, combine column Date and Time into one, and convert it into date object
